...
local icons = {
    play = "{\\p1}m 0 0 m 16 21 m 0 0 l 0 21 l 16 10.5{\\p0}",
    pause = "{\\p1}m 0 0 m 16 21 m 0 21 l 5.333333 21 l 5.333333 0 l 0 0 m 10.666667 0 l 10.666667 21 l 16 21 l 16 0{\\p0}",
...
layouts["reduced"] = function ()
    ...
    lo.geometry = {x = osc_geo.w / 2 , y = refY - 64 , an = 5, w = osc_geo.w - 50, h = 2}
    lo.layer = 13
    ...
    lo.geometry = {x = osc_geo.w / 2 , y = refY - 64 , an = 5, w = osc_geo.w - 50, h = 16}
    ...
    lo.geometry = {x = refX + 200, y = refY - 32, an = 4, w = 80, h = 2}
    lo.layer = 13
    lo.style = osc_styles.VolumebarBg
    
    lo = add_layout('volumebar')
    lo.geometry = {x = refX + 200, y = refY - 32, an = 4, w = 80, h = 8}
    ...
    lo.geometry = {x = refX + 87, y = refY - 32, an = 5, w = 30, h = 24}
    lo.style = osc_styles.Ctrl2
            
    lo = add_layout('playpause')
    lo.geometry = {x = refX + 37, y = refY - 32, an = 5, w = 45, h = 45}
    lo.style = osc_styles.Ctrl1      

    lo = add_layout('pl_next')
    lo.geometry = {x = refX + 137, y = refY - 32, an = 5, w = 30, h = 24}
    lo.style = osc_styles.Ctrl2


    -- Time
    lo = add_layout('tc_left')
    lo.geometry = {x = 300, y = refY - 32, an = 4, w = 24, h = 24}
    lo.style = osc_styles.Time       

    -- Option
    lo = add_layout('cy_sub')
    lo.geometry = {x = osc_geo.w - 237, y = refY - 32, an = 5, w = 24, h = 24}
    lo.style = osc_styles.Ctrl3
    lo.visible = (osc_param.playresx >= 540)
    
    lo = add_layout('cy_audio')
    lo.geometry = {x = osc_geo.w - 187, y = refY - 32 , an = 5, w = 24, h = 24}
    lo.style = osc_styles.Ctrl3
    lo.visible = (osc_param.playresx >= 600)

    lo = add_layout('vol_ctrl')
    lo.geometry = {x = refX + 180, y = refY - 32, an = 5, w = 24, h = 24}
    lo.style = osc_styles.Ctrl3
    lo.visible = (osc_param.playresx >= 650)

    lo = add_layout('tog_fs')
    lo.geometry = {x = osc_geo.w - 37, y = refY - 32, an = 5, w = 24, h = 24}
    lo.style = osc_styles.Ctrl2
    lo.visible = (osc_param.playresx >= 500)
    
    lo = add_layout('ontop')
    lo.geometry = {x = osc_geo.w - 137, y = refY - 32, an = 5, w = 24, h = 24}
    lo.style = osc_styles.Ctrl3
    lo.visible = (osc_param.playresx >= 600)

    lo = add_layout('tog_info')
    lo.geometry = {x = osc_geo.w - 87, y = refY - 32, an = 5, w = 24, h = 24}
    lo.style = osc_styles.Ctrl3
    lo.visible = (osc_param.playresx >= 600)
